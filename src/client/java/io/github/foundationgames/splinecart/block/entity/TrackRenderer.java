...
public enum TrackRenderer {;
    ...
    public record ImmediateBufferProvider(MultiBufferSource source, ResourceLocation texture,
                                          Function<ResourceLocation, RenderType> renderType) implements BufferProvider {
        @Override
